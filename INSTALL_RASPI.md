...
Copy the file n1mm_view.ini.sample to ~/.config/n1mm_view.ini. Note youc an also put the file in your home directory (~/) or the script directory. But the file can only be in one of those places--not two or three.
